...
def create_model(input_shape, base_model, num_classes):    
    ...
    # Apply transfer learning: freeze all layers and add extra layer that is finetuned based on our data
...
def main(model_path = 'animal_classification_model.h5'):
    ...
    #TODO: add validation data and early stopping, allowing to increase epochs
